...
">
	<h1>
		<?php the_field( 'hero_main' ); ?>
	</h1>
	<p>
		<?php the_field( 'hero_sub' ); ?>
	</p>
	<a href="#">
...
<section class="mypoint2" style="background-color: <?php the_field( 'point2_bkcolor' ); ?>;">
	<figure>
	<?php echo wp_get_attachment_image( 
		get_field( 'point2_img' )[ 'ID' ], 
		'full' 
	); ?>
	</figure>
	<div>
